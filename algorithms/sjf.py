...
def run_sjf(tasks, on_step=None):
    """
    SJF non-preemptive: tại mỗi thời điểm, chọn tác vụ đã đến có burst_time nhỏ nhất.
    """
    ...
    return build_simulation_result("SJF", completed_tasks, gantt_chart)


sjf_schedule = run_sjf
